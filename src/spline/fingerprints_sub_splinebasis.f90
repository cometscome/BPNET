submodule (fingerprints) splinebasis
    use iso_fortran_env
    implicit none
    contains
    ...
    module subroutine read_basis_spline(fp,line)
        ...
        call read_splinedata(line,paramdata,fp%num_of_coeffs,fp%Rc_max)
    ...
    module subroutine print_info_spline(fingerprint_parameters)
        ...
        write(*,*) 'Basis function type Spline'
    ...
    end subroutine print_info_spline


end submodule splinebasis